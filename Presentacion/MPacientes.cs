    ...
    public partial class MPacientes : Form
    {
        ...
        private void btnModificar_Click(object sender, EventArgs e)
        {
            if (pacienteseleccionado != null)
            {
                ...
                {
                    MessageBox.Show(gp.ActualizarPacientes(pacienteseleccionado.dnipaciente, textBoxNombres.Text, textBoxApellidos.Text,Convert.ToDateTime( dateTimePickerFechaPac.Text), Convert.ToInt32(textBoxTelefono.Text)));
                    mostrarpacientes();
        ...
        {
            if(textBoxNombres.Text == ""||textBoxApellidos.Text==""||textBoxDNI.Text == "" || textBoxTelefono.Text == "")
            {
                MessageBox.Show("Debe rellenar todos los campos");
            }
            if (textBoxNombres.Text != "" && textBoxDNI.Text != "" && textBoxApellidos.Text != "" && textBoxTelefono.Text != "" && dateTimePickerFechaPac.Text != "") { 
