...
namespace Presentacion
{
    public partial class FrmAdministrador : Form
    {
        ...
        private void tratamientoDelCancerToolStripMenuItem_Click(object sender, EventArgs e)
        {
            MTratamientoCancer mTratamiento =new MTratamientoCancer();
            mTratamiento.ShowDialog();
        }
    }
}
